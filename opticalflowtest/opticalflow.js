var PaintFlow = function(){
    ...
    this.opticalFlowMaterial = undefined;
    ...
    this.initGl = function()
    {
        ...
        this.opticalFlowMaterial = this.getMaterial('opticalFlowFragmentShader');
    ...
    this.render = function()
    {
        ...
        for(var i = 0; i < this.timesteps; ++i) {
            ...
            if (pStep == 0) {
                ...
                this.renderToTarget(this.opticalFlowMaterial, this.mTexture4, this.mTexture1, this.mTexture3, this.mTexture2);
            } else if (pStep == 1) {
                this.renderToTarget(this.feedbackMaterial,    this.mTexture4, this.mTexture1, this.mTexture2, this.mTexture3);
                this.renderToTarget(this.opticalFlowMaterial, this.mTexture3, this.mTexture4, this.mTexture2, this.mTexture1);
            } else if (pStep == 2) {
                this.renderToTarget(this.feedbackMaterial,    this.mTexture3, this.mTexture4, this.mTexture1, this.mTexture2);
                this.renderToTarget(this.opticalFlowMaterial, this.mTexture2, this.mTexture3, this.mTexture1, this.mTexture4);
            } else if (pStep == 3) {
                this.renderToTarget(this.feedbackMaterial,    this.mTexture2, this.mTexture3, this.mTexture4, this.mTexture1);
                this.renderToTarget(this.opticalFlowMaterial, this.mTexture1, this.mTexture2, this.mTexture4, this.mTexture3);
            }

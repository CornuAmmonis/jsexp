...
window.onload = function() {
    ...
    gui.add(manifoldDenoise, 'hard').min(0.0).max(50.0).step(0.1).name("Hardness");
    gui.add(manifoldDenoise, 'rate').min(0.0).max(20.0).step(0.1).name("Rate");

    manifoldDenoise.init();
};